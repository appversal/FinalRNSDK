...
const Stories = ({
  ...
  function onNavigate(storyGroup) {
    (0, _trackuseraction.UserActionTrack)(user_id, data.id, 'CLK').catch(e => console.log('Error in tracking impression:', e));
  ...
  (0, _react.useEffect)(() => {
    if (data?.details && Array.isArray(data.details)) {
      (0, _trackuseraction.UserActionTrack)(user_id, data.id, 'IMP').catch(e => console.log('Error in fetching data:', e));
    }
  }, [data, user_id]);
