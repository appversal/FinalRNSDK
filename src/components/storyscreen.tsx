...
export const StoryScreen = () => {
  ...
  return (
    ...
    >
      {content && content.length !== 0 && typeof content[current]?.image === 'string' && content[current]?.image !== '' && (
        <Image
      ...
      {
        content && content.length !== 0 && typeof content[current]?.video === 'string' && content[current]?.video !== '' &&
        <Video
      ...
      <View style={{
        ...
        <View style={{
          ...
          <View style={{
            ...
            {
              storySlideData && storySlideData.thumbnail && storySlideData.thumbnail != '' &&
              <Image source={{ uri: storySlideData.thumbnail }} style={{
                width: 40,
                height: 40,
                borderRadius: 20,
              }} />
            ...
            {
              storySlideData && storySlideData.name && storySlideData.name != '' &&
              <Text style={{
                marginLeft: 12,
                fontSize: 15,
                fontWeight: '500',
      ...
      {
        content && content[current] && content[current]?.button_text && content[current]?.link &&
        <View style={{
          position: 'absolute',
          bottom: height * 0.037,
          width: width,
